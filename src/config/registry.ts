export const registryConfig = {
   ...
   */
  namespace: process.env.REGISTRY_NAMESPACE || "@sinukumar",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://sinu.com/r/{name}.json" resolves to "https://sinu.com/r/wheel-picker.json"
   ...
   */
  namespaceUrl:
    process.env.REGISTRY_NAMESPACE_URL || "https://sinu.com/r/{name}.json",
};
